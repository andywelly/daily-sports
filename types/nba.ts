...
export interface BookOdds {
  ...
  export const NBA_TEAM_CODES: Record<string, TeamCodeInfo> = {
    ...
    'Warriors': { code: 'GS', basketball_reference_code: 'GSW', full_name: 'Golden State Warriors' },
    ...
    'Knicks': { code: 'NY', basketball_reference_code: 'NYK', full_name: 'New York Knicks' },
    ...
    'Spurs': { code: 'SA', basketball_reference_code: 'SAS', full_name: 'San Antonio Spurs' },
